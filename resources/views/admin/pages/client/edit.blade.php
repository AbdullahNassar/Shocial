                        ...
                        <div class="col-md-12">
                            <div class="portlet box green">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="{{ route('admin.client.edit' , ['id' => $client->id]) }}" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return false;">
                                        <div class="form-body">
                                            {{ csrf_field() }}
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="choose-img">
                                                        <input type="hidden" value="{{ $client->id }}" name="s_id" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" name="active" required>
                                                                <option selected value="{{ $client->active }}">@if($client->active == 1)
                                                                                Active
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <a href="{{route('admin.clients')}}" type="button" class="btn  grey-salsa btn-outline">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>

                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="choose-img">
                                                        ...
                                                        <p style="font-size: large;">Choose Icon</p>
                                                    </div><!-- End Choose-Img -->
                                                    <div class="upload-action">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="choose-img">
                                                        ...
                                                        <input type="hidden" name="image3" id="img3" >
                                                        <input type="file" name="image3" id="image3" required>
                                                        <p style="font-size: large;">Upload Background Image</p>
                                                    </div><!-- End Choose-Img -->
                                                    <div class="upload-action">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name" class="form-control " placeholder="Service Name in English ..." required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name_ar" class="form-control " placeholder="Service Name in Arabic..." required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea type="text" rows="5" name="head" class="form-control " placeholder="Service Header in English..."></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea type="text" rows="5" name="head_ar" class="form-control " placeholder="Service Header in Arabic..."></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea rows="5" type="text" name="content" class="form-control " placeholder="Service Content in English..."></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">

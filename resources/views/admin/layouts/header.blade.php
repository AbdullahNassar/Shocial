        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo" style="background-color: #26344b;">
                        <a href="{{route('admin.home')}}" style="color: #fff; margin-top: 17px; font-size: medium; margin-left: 17px; margin-bottom: 15px;"><img style="max-width: 120px;" src="{{asset('assets/site/images/logo.png')}}" alt="" />
                        </a> 
